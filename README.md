...
[![Maven Central](https://img.shields.io/maven-central/v/com.lithic.api/lithic-java)](https://central.sonatype.com/artifact/com.lithic.api/lithic-java/0.24.0)
...
```kotlin
implementation("com.lithic.api:lithic-java:0.24.0")
```
