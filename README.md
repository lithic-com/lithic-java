...
[![Maven Central](https://img.shields.io/maven-central/v/com.lithic.api/lithic-java)](https://central.sonatype.com/artifact/com.lithic.api/lithic-java/0.82.2)
[![javadoc](https://javadoc.io/badge2/com.lithic.api/lithic-java/0.82.2/javadoc.svg)](https://javadoc.io/doc/com.lithic.api/lithic-java/0.82.2)
...
The REST API documentation can be found on [docs.lithic.com](https://docs.lithic.com). Javadocs are also available on [javadoc.io](https://javadoc.io/doc/com.lithic.api/lithic-java/0.82.2).
...
```kotlin
implementation("com.lithic.api:lithic-java:0.82.2")
```
