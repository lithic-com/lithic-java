...
class AccountUpdateParams constructor(private val accountToken: String,private val dailySpendLimit: Long?,private val lifetimeSpendLimit: Long?,private val monthlySpendLimit: Long?,private val verificationAddress: VerificationAddress?,private val state: State?,private val additionalQueryParams: Map<String, List<String>>,private val additionalHeaders: Map<String, List<String>>,private val additionalBodyProperties: Map<String, JsonValue>,) {
