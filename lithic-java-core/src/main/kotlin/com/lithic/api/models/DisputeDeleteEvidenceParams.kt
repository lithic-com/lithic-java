...
class DisputeDeleteEvidenceParams constructor(private val disputeToken: String,private val evidenceToken: String,private val additionalQueryParams: Map<String, List<String>>,private val additionalHeaders: Map<String, List<String>>,private val additionalBodyProperties: Map<String, JsonValue>,) {
    ...
    override fun toString() = "DisputeDeleteEvidenceParams{disputeToken=$disputeToken, evidenceToken=$evidenceToken, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        fun build(): DisputeDeleteEvidenceParams = DisputeDeleteEvidenceParams(
            checkNotNull(disputeToken) {
                "`disputeToken` is required but was not set"
            },
            checkNotNull(evidenceToken) {
                "`evidenceToken` is required but was not set"
            },
