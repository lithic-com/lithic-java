...
class AuthStreamEnrollmentRetrieveParams constructor(private val additionalQueryParams: Map<String, List<String>>,private val additionalHeaders: Map<String, List<String>>,) {
    ...
    class Builder {
        ...
        fun build(): AuthStreamEnrollmentRetrieveParams = AuthStreamEnrollmentRetrieveParams(additionalQueryParams.mapValues { it.value.toUnmodifiable() }.toUnmodifiable(), additionalHeaders.mapValues { it.value.toUnmodifiable() }.toUnmodifiable())
    }
}
