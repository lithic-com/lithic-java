...
class FundingSourceListParams constructor(private val accountToken: String?,private val page: Long?,private val pageSize: Long?,private val additionalQueryParams: ListMultimap<String, String>,private val additionalHeaders: ListMultimap<String, String>,) {
    ...
    @JvmSynthetic
    internal fun toQueryParams(): ListMultimap<String, String> = FundingSourceListQueryParams(
        accountToken,
        page,
        pageSize,
    ...
    class FundingSourceListQueryParams internal constructor(private val accountToken: String?,private val page: Long?,private val pageSize: Long?,private val additionalProperties: ListMultimap<String, String>,) {
        ...
        override fun toString() = "FundingSourceListQueryParams{accountToken=$accountToken, page=$page, pageSize=$pageSize, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            fun build(): FundingSourceListQueryParams = FundingSourceListQueryParams(
                accountToken,
                page,
                pageSize,
    ...
    override fun toString() = "FundingSourceListParams{accountToken=$accountToken, page=$page, pageSize=$pageSize, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        fun build(): FundingSourceListParams = FundingSourceListParams(
            accountToken,
            page,
            pageSize,
