...
class TransactionRetrieveParams constructor(private val transactionToken: String,private val additionalQueryParams: ListMultimap<String, String>,private val additionalHeaders: ListMultimap<String, String>,) {
    ...
    override fun toString() = "TransactionRetrieveParams{transactionToken=$transactionToken, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        fun transactionToken(transactionToken: String) = apply { this.transactionToken = transactionToken }
        ...
        fun build(): TransactionRetrieveParams = TransactionRetrieveParams(
            checkNotNull(transactionToken) { "Property `transactionToken` is required but was not set" },
