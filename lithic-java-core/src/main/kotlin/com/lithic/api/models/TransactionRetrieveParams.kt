...
class TransactionRetrieveParams constructor(private val transactionToken: String,private val additionalQueryParams: Map<String, List<String>>,private val additionalHeaders: Map<String, List<String>>,) {
