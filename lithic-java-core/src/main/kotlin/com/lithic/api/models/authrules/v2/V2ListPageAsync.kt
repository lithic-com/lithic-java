...
private constructor(
    ...
    fun getNextPage(): CompletableFuture<Optional<V2ListPageAsync>> {
    ...
    class AutoPager(private val firstPage: V2ListPageAsync) {

        fun forEach(
            action: Predicate<V2ListResponse>,
            executor: Executor,
        ): CompletableFuture<Void> {
            fun CompletableFuture<Optional<V2ListPageAsync>>.forEach(
