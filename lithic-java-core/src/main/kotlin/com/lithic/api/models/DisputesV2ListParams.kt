...
private constructor(
     ...
     */
    fun claimToken(): Optional<String> = Optional.ofNullable(claimToken)
     ...
     */
    fun disputedTransactionToken(): Optional<String> = Optional.ofNullable(disputedTransactionToken)
    ...
    class Builder internal constructor() {
        ...
        /**
         * Alias for calling [Builder.disputedTransactionToken] with
         * `disputedTransactionToken.orElse(null)`.
         */
        fun disputedTransactionToken(disputedTransactionToken: Optional<String>) =
