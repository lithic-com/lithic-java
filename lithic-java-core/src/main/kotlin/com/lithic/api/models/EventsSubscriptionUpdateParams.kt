...
class EventsSubscriptionUpdateParams constructor(private val eventSubscriptionToken: String,private val description: String?,private val disabled: Boolean?,private val eventTypes: List<EventType>?,private val url: String,private val additionalQueryParams: Map<String, List<String>>,private val additionalHeaders: Map<String, List<String>>,private val additionalBodyProperties: Map<String, JsonValue>,) {
    ...
    @NoAutoDetect
    class EventsSubscriptionUpdateBody internal constructor(private val description: String?,private val disabled: Boolean?,private val eventTypes: List<EventType>?,private val url: String?,private val additionalProperties: Map<String, JsonValue>,) {
        ...
        override fun toString() = "EventsSubscriptionUpdateBody{description=$description, disabled=$disabled, eventTypes=$eventTypes, url=$url, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            fun build(): EventsSubscriptionUpdateBody = EventsSubscriptionUpdateBody(
                description,
                disabled,
    ...
    override fun toString() = "EventsSubscriptionUpdateParams{eventSubscriptionToken=$eventSubscriptionToken, description=$description, disabled=$disabled, eventTypes=$eventTypes, url=$url, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        fun build(): EventsSubscriptionUpdateParams = EventsSubscriptionUpdateParams(
