...
class DisputeRetrieveEvidenceParams constructor(private val disputeToken: String,private val evidenceToken: String,private val additionalQueryParams: Map<String, List<String>>,private val additionalHeaders: Map<String, List<String>>,) {
    ...
    override fun toString() = "DisputeRetrieveEvidenceParams{disputeToken=$disputeToken, evidenceToken=$evidenceToken, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        fun build(): DisputeRetrieveEvidenceParams = DisputeRetrieveEvidenceParams(
