...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        /** Alias for calling [Builder.transactionTokens] with `transactionTokens.orElse(null)`. */
        fun transactionTokens(transactionTokens: Optional<List<String>>) =
            transactionTokens(transactionTokens.getOrNull())
