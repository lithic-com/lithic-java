...
class CardUpdateParams constructor(private val cardToken: String,private val memo: String?,private val spendLimit: Long?,private val spendLimitDuration: SpendLimitDuration?,private val authRuleToken: String?,private val state: State?,private val pin: String?,private val digitalCardArtToken: String?,private val additionalQueryParams: Map<String, List<String>>,private val additionalHeaders: Map<String, List<String>>,private val additionalBodyProperties: Map<String, JsonValue>,) {
    ...
    @NoAutoDetect
    class CardUpdateBody internal constructor(private val memo: String?,private val spendLimit: Long?,private val spendLimitDuration: SpendLimitDuration?,private val authRuleToken: String?,private val state: State?,private val pin: String?,private val digitalCardArtToken: String?,private val additionalProperties: Map<String, JsonValue>,) {
        ...
        override fun toString() = "CardUpdateBody{memo=$memo, spendLimit=$spendLimit, spendLimitDuration=$spendLimitDuration, authRuleToken=$authRuleToken, state=$state, pin=$pin, digitalCardArtToken=$digitalCardArtToken, additionalProperties=$additionalProperties}"
