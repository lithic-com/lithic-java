...
class TransactionListPageAsync private constructor(private val transactionsService: TransactionServiceAsync,private val params: TransactionListParams,private val response: Response,) {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is TransactionListPageAsync &&
          transactionsService == other.transactionsService &&
          params == other.params &&
    ...
    fun getNextPageParams(): Optional<TransactionListParams> {
      return if (hasNextPage()) {
        Optional.of(TransactionListParams.builder().from(params).page(params.page().orElse(0) + 1).build())
      } else {
        Optional.empty()
      }
    }
    ...
    @NoAutoDetect
    class Response constructor(private val data: JsonField<List<Transaction>>,private val page: JsonField<Long>,private val totalEntries: JsonField<Long>,private val totalPages: JsonField<Long>,private val additionalProperties: Map<String, JsonValue>,) {
        ...
        override fun toString() = "TransactionListPageAsync.Response{data=$data, page=$page, totalEntries=$totalEntries, totalPages=$totalPages, additionalProperties=$additionalProperties}"
