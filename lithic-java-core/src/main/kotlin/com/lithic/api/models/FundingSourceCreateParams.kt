...
class FundingSourceCreateParams constructor(private val bank: Bank?,private val plaid: Plaid?,private val additionalQueryParams: ListMultimap<String, String>,private val additionalHeaders: ListMultimap<String, String>,private val additionalBodyProperties: Map<String, JsonValue>,) {
    ...
    @JvmSynthetic
    internal fun toBody(): FundingSourceCreateBody = FundingSourceCreateBody(
        bank,
        plaid,
    ...
    class FundingSourceCreateBody internal constructor(private val bank: Bank?,private val plaid: Plaid?,private val additionalProperties: Map<String, JsonValue>,) {

        private var hashCode: Int = 0

        class Serializer : BaseSerializer<FundingSourceCreateBody>(FundingSourceCreateBody::class) {

            override fun serialize(value: FundingSourceCreateBody, generator: JsonGenerator, provider: SerializerProvider) {
              generator.writeStartObject()
              when {
                  value.bank != null -> {
                      generator.writeObjectField("validation_method", value.bank.validationMethod())
                  ...
                  value.plaid != null -> {
                      generator.writeObjectField("validation_method", value.plaid.validationMethod())
        ...
        override fun toString() = "FundingSourceCreateBody{bank=$bank, plaid=$plaid, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            fun bank(bank: Bank) = apply {
                this.bank = bank
            }

            fun plaid(plaid: Plaid) = apply {
                this.plaid = plaid
            }
            ...
            fun build(): FundingSourceCreateBody = FundingSourceCreateBody(
                bank,
                plaid,
    ...
    override fun toString() = "FundingSourceCreateParams{bank=$bank, plaid=$plaid, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        fun forBank(bank: Bank) = apply {
            if (isPlaid()) {
                throw IllegalArgumentException("Params already set to another variant. FundingSourceCreateBody: ${this}")
              }
            this.bank = bank
        }
        ...
        fun build(): FundingSourceCreateParams = FundingSourceCreateParams(
            bank,
            plaid,
    ...
    @NoAutoDetect
    class Bank private constructor(private val validationMethod: ValidationMethod?,private val accountName: String?,private val accountNumber: String?,private val accountToken: String?,private val routingNumber: String?,private val additionalProperties: Map<String, JsonValue>,) {
        ...
        override fun toString() = "Bank{validationMethod=$validationMethod, accountName=$accountName, accountNumber=$accountNumber, accountToken=$accountToken, routingNumber=$routingNumber, additionalProperties=$additionalProperties}"
        ...
        class Builder {
             ...
             */
            @JsonProperty("account_name")
            fun accountName(accountName: String) = apply {
            ...
            fun build(): Bank = Bank(
                checkNotNull(validationMethod) { "Property `validationMethod` is required but was not set" },
                accountName,
                checkNotNull(accountNumber) { "Property `accountNumber` is required but was not set" },
                accountToken,
                checkNotNull(routingNumber) { "Property `routingNumber` is required but was not set" },
                additionalProperties.toUnmodifiable(),
            )
        }

        class ValidationMethod @JsonCreator private constructor(private val value: JsonField<String>,) {
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is ValidationMethod &&
                  value == other.value
            }
            ...
            fun known(): Known = when (this) {
                BANK -> Known.BANK
                else -> throw LithicInvalidDataException("Unknown FundingSourceCreateBody.Bank.ValidationMethod: $value")
            }
    ...
    @NoAutoDetect
    class Plaid private constructor(private val validationMethod: ValidationMethod?,private val accountToken: String?,private val processorToken: String?,private val additionalProperties: Map<String, JsonValue>,) {
        ...
        fun processorToken(): String? = processorToken
        ...
        override fun toString() = "Plaid{validationMethod=$validationMethod, accountToken=$accountToken, processorToken=$processorToken, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            fun build(): Plaid = Plaid(
                checkNotNull(validationMethod) { "Property `validationMethod` is required but was not set" },
                accountToken,
                checkNotNull(processorToken) { "Property `processorToken` is required but was not set" },
                additionalProperties.toUnmodifiable(),
            )
        }
        ...
        class ValidationMethod @JsonCreator private constructor(private val value: JsonField<String>,) {
            ...
            fun known(): Known = when (this) {
                PLAID -> Known.PLAID
                else -> throw LithicInvalidDataException("Unknown FundingSourceCreateBody.Plaid.ValidationMethod: $value")
            }
