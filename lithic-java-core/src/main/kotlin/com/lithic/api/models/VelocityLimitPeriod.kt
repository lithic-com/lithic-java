...
private constructor(
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = velocityLimitPeriod.accept(new VelocityLimitPeriod.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitTrailingWindowObject(TrailingWindowObject trailingWindowObject) {
     *         return Optional.of(trailingWindowObject.toString());
     *     }
     *
     *     // ...
     *
