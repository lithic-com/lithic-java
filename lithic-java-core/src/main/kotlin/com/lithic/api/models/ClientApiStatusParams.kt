...
class ClientApiStatusParams constructor(private val additionalQueryParams: ListMultimap<String, String>,private val additionalHeaders: ListMultimap<String, String>,) {
    ...
    class Builder {
        ...
        fun build(): ClientApiStatusParams = ClientApiStatusParams(additionalQueryParams.toUnmodifiable(), additionalHeaders.toUnmodifiable())
    }
}
