...
private constructor(
    ...
    fun getNextPageParams(): Optional<StatementListParams> {
        if (!hasNextPage()) {
    ...
    fun getNextPage(): CompletableFuture<Optional<StatementListPageAsync>> {
    ...
    class AutoPager(private val firstPage: StatementListPageAsync) {

        fun forEach(action: Predicate<Statement>, executor: Executor): CompletableFuture<Void> {
            fun CompletableFuture<Optional<StatementListPageAsync>>.forEach(
