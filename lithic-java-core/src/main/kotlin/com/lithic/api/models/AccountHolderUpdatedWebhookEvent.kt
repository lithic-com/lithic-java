...
private constructor(
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = accountHolderUpdatedWebhookEvent.accept(new AccountHolderUpdatedWebhookEvent.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitKybPayload(KybPayload kybPayload) {
