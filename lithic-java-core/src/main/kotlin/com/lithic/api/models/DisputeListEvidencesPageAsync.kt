...
class DisputeListEvidencesPageAsync private constructor(private val disputesService: DisputeServiceAsync,private val params: DisputeListEvidencesParams,private val response: Response,) {
    ...
    override fun toString() = "DisputeListEvidencesPageAsync{disputesService=$disputesService, params=$params, response=$response}"
    ...
    fun getNextPage(): CompletableFuture<Optional<DisputeListEvidencesPageAsync>> {
      return getNextPageParams().map {
        disputesService.listEvidences(it).thenApply { Optional.of(it) }
      }.orElseGet {
    ...
    companion object {
        ...
        @JvmStatic
        fun of(disputesService: DisputeServiceAsync, params: DisputeListEvidencesParams, response: Response) = DisputeListEvidencesPageAsync(
            disputesService,
            params,
            response,
        )
    ...
    class Response constructor(private val data: JsonField<List<DisputeEvidence>>,private val hasMore: JsonField<Boolean>,private val additionalProperties: Map<String, JsonValue>,) {
        ...
        override fun toString() = "DisputeListEvidencesPageAsync.Response{data=$data, hasMore=$hasMore, additionalProperties=$additionalProperties}"
