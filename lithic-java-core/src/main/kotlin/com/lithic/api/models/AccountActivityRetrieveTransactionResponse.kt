...
private constructor(
     ...
     */
    fun hold(): Optional<Hold> = Optional.ofNullable(hold)
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = accountActivityRetrieveTransactionResponse.accept(new AccountActivityRetrieveTransactionResponse.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitInternal(FinancialTransaction internal_) {
