...
class CardEmbedParams constructor(private val embedRequest: String?,private val hmac: String?,private val additionalQueryParams: Map<String, List<String>>,private val additionalHeaders: Map<String, List<String>>,) {
    ...
    internal fun getQueryParams(): Map<String, List<String>> {
      ...
      this.embedRequest?.let {
          params.put("embed_request", listOf(it.toString()))
      }
      this.hmac?.let {
          params.put("hmac", listOf(it.toString()))
      }
