...
private constructor(
    ...
    fun getNextPageParams(): Optional<LoanTapeListParams> {
        if (!hasNextPage()) {
    ...
    fun getNextPage(): CompletableFuture<Optional<LoanTapeListPageAsync>> {
    ...
    class AutoPager(private val firstPage: LoanTapeListPageAsync) {

        fun forEach(action: Predicate<LoanTape>, executor: Executor): CompletableFuture<Void> {
            fun CompletableFuture<Optional<LoanTapeListPageAsync>>.forEach(
