...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): TokenizationResendActivationCodeParams = builder().build()
    ...
    private constructor(
        ...
        fun validate(): Body = apply {
            ...
            activationMethodType().ifPresent { it.validate() }
            validated = true
        }
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (activationMethodType.asKnown().getOrNull()?.validity() ?: 0)
