...
private constructor(
    ...
    fun cardAuthorizationChallenge(): Optional<CardAuthorizationChallengeWebhookEvent> =
        Optional.ofNullable(cardAuthorizationChallenge)
    ...
    fun cardPinUpdated(): Optional<CardPinUpdatedWebhookEvent> = Optional.ofNullable(cardPinUpdated)
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = parsedWebhookEvent.accept(new ParsedWebhookEvent.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitAccountHolderCreated(AccountHolderCreatedWebhookEvent accountHolderCreated) {
     *         return Optional.of(accountHolderCreated.toString());
     *     }
     *
     *     // ...
     *
