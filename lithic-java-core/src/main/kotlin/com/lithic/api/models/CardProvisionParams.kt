...
class CardProvisionParams constructor(private val cardToken: String,private val digitalWallet: DigitalWallet?,private val nonce: String?,private val nonceSignature: String?,private val certificate: String?,private val accountToken: String?,private val additionalQueryParams: ListMultimap<String, String>,private val additionalHeaders: ListMultimap<String, String>,private val additionalBodyProperties: Map<String, JsonValue>,) {
    ...
    @JvmSynthetic
    internal fun toBody(): CardProvisionBody = CardProvisionBody(
        digitalWallet,
        nonce,
        nonceSignature,
        certificate,
    ...
    @NoAutoDetect
    class CardProvisionBody internal constructor(private val digitalWallet: DigitalWallet?,private val nonce: String?,private val nonceSignature: String?,private val certificate: String?,private val accountToken: String?,private val additionalProperties: Map<String, JsonValue>,) {
        ...
        override fun toString() = "CardProvisionBody{digitalWallet=$digitalWallet, nonce=$nonce, nonceSignature=$nonceSignature, certificate=$certificate, accountToken=$accountToken, additionalProperties=$additionalProperties}"
    ...
    override fun toString() = "CardProvisionParams{cardToken=$cardToken, digitalWallet=$digitalWallet, nonce=$nonce, nonceSignature=$nonceSignature, certificate=$certificate, accountToken=$accountToken, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        /** Name of digital wallet provider. */
        fun digitalWallet(digitalWallet: DigitalWallet) = apply { this.digitalWallet = digitalWallet }
    ...
    class DigitalWallet @JsonCreator private constructor(private val value: JsonField<String>,) {
        ...
        fun known(): Known = when (this) {
            ...
            else -> throw LithicInvalidDataException("Unknown CardProvisionBody.DigitalWallet: $value")
        }
