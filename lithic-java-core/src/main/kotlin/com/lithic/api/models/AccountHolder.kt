...
@NoAutoDetect
class AccountHolder private constructor(private val token: JsonField<String>,private val accountToken: JsonField<String>,private val businessAccountToken: JsonField<String>,private val status: JsonField<Status>,private val statusReasons: JsonField<List<StatusReason>>,private val additionalProperties: Map<String, JsonValue>,) {
     ...
     */
    fun businessAccountToken(): Optional<String> = Optional.ofNullable(businessAccountToken.getNullable("business_account_token"))
    ...
    override fun toString() = "AccountHolder{token=$token, accountToken=$accountToken, businessAccountToken=$businessAccountToken, status=$status, statusReasons=$statusReasons, additionalProperties=$additionalProperties}"
    ...
    class StatusReason @JsonCreator private constructor(private val value: JsonField<String>,) {
        ...
        companion object {
            ...
            @JvmField val ADDRESS_VERIFICATION_FAILURE = StatusReason(JsonField.of("ADDRESS_VERIFICATION_FAILURE"))

            @JvmField val AGE_THRESHOLD_FAILURE = StatusReason(JsonField.of("AGE_THRESHOLD_FAILURE"))

            @JvmField val COMPLETE_VERIFICATION_FAILURE = StatusReason(JsonField.of("COMPLETE_VERIFICATION_FAILURE"))

            @JvmField val DOB_VERIFICATION_FAILURE = StatusReason(JsonField.of("DOB_VERIFICATION_FAILURE"))

            @JvmField val ID_VERIFICATION_FAILURE = StatusReason(JsonField.of("ID_VERIFICATION_FAILURE"))

            @JvmField val MAX_DOCUMENT_ATTEMPTS = StatusReason(JsonField.of("MAX_DOCUMENT_ATTEMPTS"))

            @JvmField val MAX_RESUBMISSION_ATTEMPTS = StatusReason(JsonField.of("MAX_RESUBMISSION_ATTEMPTS"))

            @JvmField val NAME_VERIFICATION_FAILURE = StatusReason(JsonField.of("NAME_VERIFICATION_FAILURE"))

            @JvmField val OTHER_VERIFICATION_FAILURE = StatusReason(JsonField.of("OTHER_VERIFICATION_FAILURE"))

            @JvmField val RISK_THRESHOLD_FAILURE = StatusReason(JsonField.of("RISK_THRESHOLD_FAILURE"))

            @JvmField val WATCHLIST_ALERT_FAILURE = StatusReason(JsonField.of("WATCHLIST_ALERT_FAILURE"))
