...
@NoAutoDetect
class AccountHolder private constructor(private val token: JsonField<String>,private val accountToken: JsonField<String>,private val status: JsonField<Status>,private val statusReasons: JsonField<List<StatusReason>>,private val additionalProperties: Map<String, JsonValue>,) {
    ...
    override fun toString() = "AccountHolder{token=$token, accountToken=$accountToken, status=$status, statusReasons=$statusReasons, additionalProperties=$additionalProperties}"
    ...
    class StatusReason @JsonCreator private constructor(private val value: JsonField<String>,) {
        ...
        fun known(): Known = when (this) {
            ...
            else -> throw LithicInvalidDataException("Unknown AccountHolder.StatusReason: $value")
        }
