...
private constructor(
    ...
    fun kybKycPatch(): Optional<KybKycPatchResponse> = Optional.ofNullable(kybKycPatch)

    fun patch(): Optional<PatchResponse> = Optional.ofNullable(patch)
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = accountHolderUpdateResponse.accept(new AccountHolderUpdateResponse.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitKybKycPatch(KybKycPatchResponse kybKycPatch) {
    ...
    companion object {
        ...
        @JvmStatic fun ofPatch(patch: PatchResponse) = AccountHolderUpdateResponse(patch = patch)
    }
