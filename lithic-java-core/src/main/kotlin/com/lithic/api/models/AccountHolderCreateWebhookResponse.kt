...
@NoAutoDetect
class AccountHolderCreateWebhookResponse private constructor(private val data: JsonField<Data>,private val additionalProperties: Map<String, JsonValue>,) {
    ...
    override fun toString() = "AccountHolderCreateWebhookResponse{data=$data, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(accountHolderCreateWebhookResponse: AccountHolderCreateWebhookResponse) = apply {
        ...
        fun build(): AccountHolderCreateWebhookResponse = AccountHolderCreateWebhookResponse(data, additionalProperties.toUnmodifiable())
    }

    @JsonDeserialize(builder = Data.Builder::class)
    @NoAutoDetect
    class Data private constructor(private val hmacToken: JsonField<String>,private val additionalProperties: Map<String, JsonValue>,) {
        ...
        override fun toString() = "Data{hmacToken=$hmacToken, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            @JsonProperty("hmac_token")
            @ExcludeMissing
            fun hmacToken(hmacToken: JsonField<String>) = apply {
