...
private constructor(
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = cardWebProvisionResponse.accept(new CardWebProvisionResponse.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitAppleWebPushProvisioning(AppleWebPushProvisioningResponse appleWebPushProvisioning) {
