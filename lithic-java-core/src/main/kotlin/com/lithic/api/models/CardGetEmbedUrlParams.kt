...
class CardGetEmbedUrlParams constructor(private val css: String?,private val expiration: OffsetDateTime?,private val token: String,private val targetOrigin: String?,private val additionalQueryParams: Map<String, List<String>>,private val additionalHeaders: Map<String, List<String>>,private val additionalBodyProperties: Map<String, JsonValue>,) {
    ...
    @NoAutoDetect
    class CardGetEmbedUrlBody internal constructor(private val css: String?,private val expiration: OffsetDateTime?,private val token: String?,private val targetOrigin: String?,private val additionalProperties: Map<String, JsonValue>,) {
        ...
        override fun toString() = "CardGetEmbedUrlBody{css=$css, expiration=$expiration, token=$token, targetOrigin=$targetOrigin, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            fun build(): CardGetEmbedUrlBody = CardGetEmbedUrlBody(
                css,
                expiration,
                checkNotNull(token) {
    ...
    override fun toString() = "CardGetEmbedUrlParams{css=$css, expiration=$expiration, token=$token, targetOrigin=$targetOrigin, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        fun build(): CardGetEmbedUrlParams = CardGetEmbedUrlParams(
            css,
            expiration,
            checkNotNull(token) {
                "`token` is required but was not set"
