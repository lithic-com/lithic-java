...
class AccountHolderRetrieveParams constructor(private val accountHolderToken: String,private val additionalQueryParams: Map<String, List<String>>,private val additionalHeaders: Map<String, List<String>>,) {
