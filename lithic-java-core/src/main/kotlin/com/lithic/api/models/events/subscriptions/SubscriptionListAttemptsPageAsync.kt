...
private constructor(
    ...
    fun getNextPageParams(): Optional<SubscriptionListAttemptsParams> {
        if (!hasNextPage()) {
    ...
    fun getNextPage(): CompletableFuture<Optional<SubscriptionListAttemptsPageAsync>> {
    ...
    class AutoPager(private val firstPage: SubscriptionListAttemptsPageAsync) {
        ...
        fun forEach(
            ...
            fun CompletableFuture<Optional<SubscriptionListAttemptsPageAsync>>.forEach(
