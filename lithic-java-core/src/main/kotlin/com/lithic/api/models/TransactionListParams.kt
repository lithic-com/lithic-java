...
class TransactionListParams constructor(private val accountToken: String?,private val cardToken: String?,private val result: Result?,private val begin: OffsetDateTime?,private val end: OffsetDateTime?,private val page: Long?,private val pageSize: Long?,private val additionalQueryParams: Map<String, List<String>>,private val additionalHeaders: Map<String, List<String>>,) {
    ...
    internal fun getQueryParams(): Map<String, List<String>> {
      ...
      this.accountToken?.let {
          params.put("account_token", listOf(it.toString()))
      }
      this.cardToken?.let {
          params.put("card_token", listOf(it.toString()))
      }
      this.result?.let {
          params.put("result", listOf(it.toString()))
      }
      this.begin?.let {
