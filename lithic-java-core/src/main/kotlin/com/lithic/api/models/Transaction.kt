...
private constructor(
    ...
    private constructor(
        ...
        @JvmSynthetic
        internal fun validity(): Int =
            (if (threeDSVersion.asKnown().isPresent) 1 else 0) +
                ...
                (verificationAttempted.asKnown().getOrNull()?.validity() ?: 0) +
    ...
    private constructor(
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (walletType.asKnown().getOrNull()?.validity() ?: 0)
