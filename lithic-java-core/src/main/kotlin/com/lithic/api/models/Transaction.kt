...
@NoAutoDetect
class Transaction private constructor(private val acquirerReferenceNumber: JsonField<String>,private val amount: JsonField<Long>,private val authorizationAmount: JsonField<Long>,private val cardholderAuthentication: JsonField<CardholderAuthentication>,private val merchantAmount: JsonField<Long>,private val merchantAuthorizationAmount: JsonField<Long>,private val merchantCurrency: JsonField<String>,private val authorizationCode: JsonField<String>,private val card: JsonField<Card>,private val cardToken: JsonField<String>,private val created: JsonField<String>,private val events: JsonField<List<Event>>,private val funding: JsonField<List<Funding>>,private val merchant: JsonField<Merchant>,private val network: JsonField<Network>,private val result: JsonField<Result>,private val settledAmount: JsonField<Long>,private val status: JsonField<Status>,private val token: JsonField<String>,private val additionalProperties: Map<String, JsonValue>,) {
    ...
    class Builder {
        ...
        @JsonProperty("funding")
        @ExcludeMissing
        fun funding(funding: JsonField<List<Funding>>) = apply {
    ...
    class CardholderAuthentication private constructor(private val _3dsVersion: JsonField<String>,private val acquirerExemption: JsonField<AcquirerExemption>,private val liabilityShift: JsonField<LiabilityShift>,private val verificationAttempted: JsonField<VerificationAttempted>,private val verificationResult: JsonField<VerificationResult>,private val additionalProperties: Map<String, JsonValue>,) {
        ...
        class AcquirerExemption @JsonCreator private constructor(private val value: JsonField<String>,) {
            ...
            fun known(): Known = when (this) {
                ...
                else -> throw LithicInvalidDataException("Unknown Transaction.CardholderAuthentication.AcquirerExemption: $value")
            }
        ...
        class LiabilityShift @JsonCreator private constructor(private val value: JsonField<String>,) {
            ...
            fun known(): Known = when (this) {
                ...
                else -> throw LithicInvalidDataException("Unknown Transaction.CardholderAuthentication.LiabilityShift: $value")
            }
        ...
        class VerificationAttempted @JsonCreator private constructor(private val value: JsonField<String>,) {
            ...
            fun known(): Known = when (this) {
                ...
                OTHER -> Known.OTHER
                OTP -> Known.OTP
                else -> throw LithicInvalidDataException("Unknown Transaction.CardholderAuthentication.VerificationAttempted: $value")
            }
        ...
        class VerificationResult @JsonCreator private constructor(private val value: JsonField<String>,) {
            ...
            fun known(): Known = when (this) {
                ...
                else -> throw LithicInvalidDataException("Unknown Transaction.CardholderAuthentication.VerificationResult: $value")
            }
    ...
    @NoAutoDetect
    class Event private constructor(private val amount: JsonField<Long>,private val created: JsonField<String>,private val result: JsonField<Result>,private val token: JsonField<String>,private val type: JsonField<Type>,private val additionalProperties: Map<String, JsonValue>,) {
        ...
        override fun toString() = "Event{amount=$amount, created=$created, result=$result, token=$token, type=$type, additionalProperties=$additionalProperties}"
        ...
        class Result @JsonCreator private constructor(private val value: JsonField<String>,) {
            ...
            fun known(): Known = when (this) {
                ...
                else -> throw LithicInvalidDataException("Unknown Transaction.Event.Result: $value")
            }
        ...
        class Type @JsonCreator private constructor(private val value: JsonField<String>,) {
            ...
            fun known(): Known = when (this) {
                ...
                VOID -> Known.VOID
                else -> throw LithicInvalidDataException("Unknown Transaction.Event.Type: $value")
            }
    ...
    @NoAutoDetect
    class Funding private constructor(private val amount: JsonField<Long>,private val token: JsonField<String>,private val type: JsonField<Type>,private val additionalProperties: Map<String, JsonValue>,) {
        ...
        override fun toString() = "Funding{amount=$amount, token=$token, type=$type, additionalProperties=$additionalProperties}"
        ...
        class Type @JsonCreator private constructor(private val value: JsonField<String>,) {
            ...
            fun known(): Known = when (this) {
                ...
                else -> throw LithicInvalidDataException("Unknown Transaction.Funding.Type: $value")
            }
