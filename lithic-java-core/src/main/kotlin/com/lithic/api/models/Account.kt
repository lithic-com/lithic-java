...
@NoAutoDetect
class Account private constructor(private val spendLimit: JsonField<SpendLimit>,private val state: JsonField<State>,private val token: JsonField<String>,private val authRuleTokens: JsonField<List<String>>,private val verificationAddress: JsonField<VerificationAddress>,private val accountHolder: JsonField<AccountHolder>,private val additionalProperties: Map<String, JsonValue>,) {
    ...
    fun authRuleTokens(): Optional<List<String>> = Optional.ofNullable(authRuleTokens.getNullable("auth_rule_tokens"))

    fun verificationAddress(): Optional<VerificationAddress> = Optional.ofNullable(verificationAddress.getNullable("verification_address"))
    ...
    @ExcludeMissing
    fun _authRuleTokens() = authRuleTokens
    ...
    override fun toString() = "Account{spendLimit=$spendLimit, state=$state, token=$token, authRuleTokens=$authRuleTokens, verificationAddress=$verificationAddress, accountHolder=$accountHolder, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        /** List of identifiers for the Auth Rule(s) that are applied on the account. */
        fun authRuleTokens(authRuleTokens: List<String>) = authRuleTokens(JsonField.of(authRuleTokens))
        ...
        fun verificationAddress(verificationAddress: VerificationAddress) = verificationAddress(JsonField.of(verificationAddress))
    ...
    @NoAutoDetect
    class SpendLimit private constructor(private val daily: JsonField<Long>,private val monthly: JsonField<Long>,private val lifetime: JsonField<Long>,private val additionalProperties: Map<String, JsonValue>,) {
        ...
        @ExcludeMissing
        fun _monthly() = monthly

        /** Total spend limit over account lifetime (in cents). */
        @JsonProperty("lifetime")
        @ExcludeMissing
        fun _lifetime() = lifetime
        ...
        override fun toString() = "SpendLimit{daily=$daily, monthly=$monthly, lifetime=$lifetime, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            fun build(): SpendLimit = SpendLimit(
                daily,
                monthly,
                lifetime,
                additionalProperties.toUnmodifiable(),
    ...
    @NoAutoDetect
    class VerificationAddress private constructor(private val address1: JsonField<String>,private val address2: JsonField<String>,private val city: JsonField<String>,private val state: JsonField<String>,private val postalCode: JsonField<String>,private val country: JsonField<String>,private val additionalProperties: Map<String, JsonValue>,) {
    ...
    @NoAutoDetect
    class AccountHolder private constructor(private val token: JsonField<String>,private val phoneNumber: JsonField<String>,private val email: JsonField<String>,private val businessAccountToken: JsonField<String>,private val additionalProperties: Map<String, JsonValue>,) {
         ...
         */
        fun businessAccountToken(): String = businessAccountToken.getRequired("business_account_token")
        ...
        override fun toString() = "AccountHolder{token=$token, phoneNumber=$phoneNumber, email=$email, businessAccountToken=$businessAccountToken, additionalProperties=$additionalProperties}"
        ...
        class Builder {
             ...
             * enrolled AUTHORIZED_USER individual.
             */
            fun businessAccountToken(businessAccountToken: String) = businessAccountToken(JsonField.of(businessAccountToken))
            ...
            fun build(): AccountHolder = AccountHolder(
                token,
                phoneNumber,
                email,
                businessAccountToken,
