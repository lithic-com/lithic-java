...
private constructor(
    ...
    fun authorizationResult(): Optional<AuthorizationResult> =
        Optional.ofNullable(authorizationResult)

    fun authentication3dsResult(): Optional<Authentication3dsResult> =
        Optional.ofNullable(authentication3dsResult)

    fun tokenizationResult(): Optional<TokenizationResult> = Optional.ofNullable(tokenizationResult)

    fun achResult(): Optional<AchResult> = Optional.ofNullable(achResult)

    fun cardTransactionUpdateResult(): Optional<CardTransactionUpdateResult> =
        Optional.ofNullable(cardTransactionUpdateResult)

    fun achPaymentUpdateResult(): Optional<AchPaymentUpdateResult> =
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = v2ListResultsResponse.accept(new V2ListResultsResponse.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitAuthorizationResult(AuthorizationResult authorizationResult) {
     *         return Optional.of(authorizationResult.toString());
     *     }
     *
     *     // ...
     *
    ...
    private constructor(
        ...
        private constructor(
             ...
             *     @Override
             *     public Optional<String> visitDeclineActionAuthorization(DeclineActionAuthorization declineActionAuthorization) {
             *         return Optional.of(declineActionAuthorization.toString());
             *     }
             *
             *     // ...
             *
    ...
    private constructor(
        ...
        private constructor(
             ...
             * Optional<String> result = action.accept(new Action.Visitor<Optional<String>>() {
             *     @Override
             *     public Optional<String> visitDeclineActionTokenization(DeclineActionTokenization declineActionTokenization) {
             *         return Optional.of(declineActionTokenization.toString());
             *     }
             *
             *     // ...
             *
    ...
    private constructor(
        ...
        private constructor(
             ...
             * Optional<String> result = action.accept(new Action.Visitor<Optional<String>>() {
             *     @Override
             *     public Optional<String> visitApproveActionAch(ApproveActionAch approveActionAch) {
