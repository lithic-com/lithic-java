...
class EventsSubscriptionListParams constructor(private val pageSize: Long?,private val startingAfter: String?,private val endingBefore: String?,private val additionalQueryParams: Map<String, List<String>>,private val additionalHeaders: Map<String, List<String>>,) {
    ...
    override fun toString() = "EventsSubscriptionListParams{pageSize=$pageSize, startingAfter=$startingAfter, endingBefore=$endingBefore, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        fun build(): EventsSubscriptionListParams = EventsSubscriptionListParams(
            pageSize,
            startingAfter,
            endingBefore,
