...
@NoAutoDetect
class TransactionSimulateClearingResponse private constructor(private val debuggingRequestId: JsonField<String>,private val additionalProperties: Map<String, JsonValue>,) {
    ...
    override fun toString() = "TransactionSimulateClearingResponse{debuggingRequestId=$debuggingRequestId, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(transactionSimulateClearingResponse: TransactionSimulateClearingResponse) = apply {
        ...
        fun build(): TransactionSimulateClearingResponse = TransactionSimulateClearingResponse(debuggingRequestId, additionalProperties.toUnmodifiable())
    }
}
