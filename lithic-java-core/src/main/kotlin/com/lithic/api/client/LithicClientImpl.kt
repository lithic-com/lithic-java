...
class LithicClientImpl constructor(private val clientOptions: ClientOptions,) : LithicClient {
    ...
    private val fundingSources: FundingSourceService by lazy { FundingSourceServiceImpl(clientOptions) }
    ...
    /** API status check */
    override fun apiStatus(params: ClientApiStatusParams, requestOptions: RequestOptions): ApiStatus {
