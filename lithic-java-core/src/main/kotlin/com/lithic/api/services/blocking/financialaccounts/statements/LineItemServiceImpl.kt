...
class LineItemServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        private val listHandler: Handler<LineItemListPage.Response> =
            jsonHandler<LineItemListPage.Response>(clientOptions.jsonMapper)
        ...
        override fun list(
            ...
            return response.parseable {
                response
                    ...
                    .let { LineItemListPage.of(LineItemServiceImpl(clientOptions), params, it) }
            }
        }
    }
}
