...
class OpenToBuyServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): OpenToBuyServiceAsync =
        OpenToBuyServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
