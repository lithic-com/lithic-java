...
interface BacktestServiceAsync {
     ...
     * report.
     */
    fun create(params: BacktestCreateParams): CompletableFuture<BacktestCreateResponse> =
     ...
     */
    fun retrieve(params: BacktestRetrieveParams): CompletableFuture<BacktestResults> =
