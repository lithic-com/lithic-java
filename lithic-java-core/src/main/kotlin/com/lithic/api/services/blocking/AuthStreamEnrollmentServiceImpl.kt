...
class AuthStreamEnrollmentServiceImpl constructor(private val clientOptions: ClientOptions,) : AuthStreamEnrollmentService {
     ...
     */
    override fun retrieve(params: AuthStreamEnrollmentRetrieveParams, requestOptions: RequestOptions): AuthStreamEnrollment {
    ...
    override fun disenroll(params: AuthStreamEnrollmentDisenrollParams, requestOptions: RequestOptions) {
      val request = HttpRequest.builder()
        ...
        .build()
      clientOptions.httpClient.execute(request)
      .let { response -> 
          response.let {
