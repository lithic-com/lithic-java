...
class AuthRuleServiceAsyncImpl constructor(private val clientOptions: ClientOptions,) : AuthRuleServiceAsync {
     ...
     */
    override fun create(params: AuthRuleCreateParams, requestOptions: RequestOptions): CompletableFuture<AuthRuleCreateResponse> {
     ...
     */
    override fun retrieve(params: AuthRuleRetrieveParams, requestOptions: RequestOptions): CompletableFuture<AuthRuleRetrieveResponse> {
      val request = HttpRequest.builder()
     ...
     * Rule).
     */
    override fun update(params: AuthRuleUpdateParams, requestOptions: RequestOptions): CompletableFuture<AuthRuleUpdateResponse> {
      val request = HttpRequest.builder()
    ...
    override fun list(params: AuthRuleListParams, requestOptions: RequestOptions): CompletableFuture<AuthRuleListPageAsync> {
      val request = HttpRequest.builder()
        .method(HttpMethod.GET)
        .addPathSegments("auth_rules")
        .putAllQueryParams(params.toQueryParams())
      ...
      .thenApply { response -> 
          ...
          .let {
              AuthRuleListPageAsync.of(this, params, it)
          }
      }
    }
     ...
     * card level.
     */
    override fun apply(params: AuthRuleApplyParams, requestOptions: RequestOptions): CompletableFuture<AuthRuleApplyResponse> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
     ...
     * card-level.
     */
    override fun remove(params: AuthRuleRemoveParams, requestOptions: RequestOptions): CompletableFuture<AuthRuleRemoveResponse> {
      val request = HttpRequest.builder()
