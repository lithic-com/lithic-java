...
class TransactionServiceAsyncImpl constructor(private val clientOptions: ClientOptions,) : TransactionServiceAsync {
     ...
     * endpoint.
     */
    override fun simulateAuthorization(params: TransactionSimulateAuthorizationParams, requestOptions: RequestOptions): CompletableFuture<TransactionSimulateAuthorizationResponse> {
      val request = HttpRequest.builder()
     ...
     */
    override fun simulateClearing(params: TransactionSimulateClearingParams, requestOptions: RequestOptions): CompletableFuture<TransactionSimulateClearingResponse> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
     ...
     * network.
     */
    override fun simulateCreditAuthorization(params: TransactionSimulateCreditAuthorizationParams, requestOptions: RequestOptions): CompletableFuture<TransactionSimulateCreditAuthorizationResponse> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
     ...
     */
    override fun simulateReturn(params: TransactionSimulateReturnParams, requestOptions: RequestOptions): CompletableFuture<TransactionSimulateReturnResponse> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
     ...
     */
    override fun simulateReturnReversal(params: TransactionSimulateReturnReversalParams, requestOptions: RequestOptions): CompletableFuture<TransactionSimulateReturnReversalResponse> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
     ...
     */
    override fun simulateVoid(params: TransactionSimulateVoidParams, requestOptions: RequestOptions): CompletableFuture<TransactionSimulateVoidResponse> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
