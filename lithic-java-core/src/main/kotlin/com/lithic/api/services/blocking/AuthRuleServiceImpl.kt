...
class AuthRuleServiceImpl constructor(private val clientOptions: ClientOptions,) : AuthRuleService {
     ...
     */
    override fun create(params: AuthRuleCreateParams, requestOptions: RequestOptions): AuthRuleCreateResponse {
     ...
     */
    override fun retrieve(params: AuthRuleRetrieveParams, requestOptions: RequestOptions): AuthRuleRetrieveResponse {
      val request = HttpRequest.builder()
     ...
     * Rule).
     */
    override fun update(params: AuthRuleUpdateParams, requestOptions: RequestOptions): AuthRuleUpdateResponse {
      val request = HttpRequest.builder()
    ...
    override fun list(params: AuthRuleListParams, requestOptions: RequestOptions): AuthRuleListPage {
      val request = HttpRequest.builder()
        .method(HttpMethod.GET)
        .addPathSegments("auth_rules")
        .putAllQueryParams(params.toQueryParams())
      ...
      .let { response -> 
          ...
          .let {
              AuthRuleListPage.of(this, params, it)
          }
      }
    }
     ...
     * card level.
     */
    override fun apply(params: AuthRuleApplyParams, requestOptions: RequestOptions): AuthRuleApplyResponse {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
     ...
     * card-level.
     */
    override fun remove(params: AuthRuleRemoveParams, requestOptions: RequestOptions): AuthRuleRemoveResponse {
      val request = HttpRequest.builder()
