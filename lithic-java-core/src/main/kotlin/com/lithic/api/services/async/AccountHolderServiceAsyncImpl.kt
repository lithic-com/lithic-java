...
class AccountHolderServiceAsyncImpl constructor(private val clientOptions: ClientOptions,) : AccountHolderServiceAsync {
     ...
     */
    override fun create(params: AccountHolderCreateParams, requestOptions: RequestOptions): CompletableFuture<AccountHolder> {
    ...
    override fun retrieve(params: AccountHolderRetrieveParams, requestOptions: RequestOptions): CompletableFuture<AccountHolder> {
      val request = HttpRequest.builder()
    ...
    override fun update(params: AccountHolderUpdateParams, requestOptions: RequestOptions): CompletableFuture<AccountHolderUpdateResponse> {
      val request = HttpRequest.builder()
     ...
     */
    override fun createWebhook(params: AccountHolderCreateWebhookParams, requestOptions: RequestOptions): CompletableFuture<AccountHolderCreateWebhookResponse> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
      ...
      .thenApply { response -> 
          response.let {
              createWebhookHandler.handle(it)
          }
          .apply  {
              if (requestOptions.responseValidation ?: clientOptions.responseValidation) {
                validate()
     ...
     */
    override fun listDocuments(params: AccountHolderListDocumentsParams, requestOptions: RequestOptions): CompletableFuture<AccountHolderListDocumentsResponse> {
      val request = HttpRequest.builder()
        .method(HttpMethod.GET)
     ...
     */
    override fun resubmit(params: AccountHolderResubmitParams, requestOptions: RequestOptions): CompletableFuture<AccountHolder> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
     ...
     */
    override fun retrieveDocument(params: AccountHolderRetrieveDocumentParams, requestOptions: RequestOptions): CompletableFuture<AccountHolderDocument> {
      val request = HttpRequest.builder()
        .method(HttpMethod.GET)
        .addPathSegments("account_holders", params.getPathParam(0), "documents", params.getPathParam(1))
        .putAllQueryParams(params.toQueryParams())
        .putHeader("Authorization", clientOptions.apiKey)
        .putAllHeaders(params.toHeaders())
        .build()
     ...
     * verification.
     */
    override fun uploadDocument(params: AccountHolderUploadDocumentParams, requestOptions: RequestOptions): CompletableFuture<AccountHolderDocument> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
        .addPathSegments("account_holders", params.getPathParam(0), "documents")
        .putAllQueryParams(params.toQueryParams())
