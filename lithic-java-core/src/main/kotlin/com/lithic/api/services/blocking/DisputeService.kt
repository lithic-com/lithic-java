...
interface DisputeService {
    ...
    /** Initiate a dispute. */
    @JvmOverloads
    fun create(params: DisputeCreateParams, requestOptions: RequestOptions = RequestOptions.none()): Dispute

    /** Get dispute. */
    @JvmOverloads
    fun retrieve(params: DisputeRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): Dispute

    /** Update dispute. Can only be modified if status is `NEW`. */
    @JvmOverloads
    fun update(params: DisputeUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): Dispute

    /** List disputes. */
    @JvmOverloads
    fun list(params: DisputeListParams, requestOptions: RequestOptions = RequestOptions.none()): DisputeListPage

    /** Withdraw dispute. */
    @JvmOverloads
    fun delete(params: DisputeDeleteParams, requestOptions: RequestOptions = RequestOptions.none()): Dispute
     ...
     */
    @JvmOverloads
    fun deleteEvidence(params: DisputeDeleteEvidenceParams, requestOptions: RequestOptions = RequestOptions.none()): DisputeEvidence
     ...
     */
    @JvmOverloads
    fun initiateEvidenceUpload(params: DisputeInitiateEvidenceUploadParams, requestOptions: RequestOptions = RequestOptions.none()): DisputeInitiateEvidenceUploadResponse

    /** List evidence metadata for a dispute. */
    @JvmOverloads
    fun listEvidences(params: DisputeListEvidencesParams, requestOptions: RequestOptions = RequestOptions.none()): DisputeListEvidencesPage

    /** Get a dispute's evidence metadata. */
    @JvmOverloads
    fun retrieveEvidence(params: DisputeRetrieveEvidenceParams, requestOptions: RequestOptions = RequestOptions.none()): DisputeEvidence
