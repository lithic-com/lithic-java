...
interface StatementServiceAsync {
    ...
    fun retrieve(params: StatementRetrieveParams): CompletableFuture<Statement> =
    ...
    fun list(params: StatementListParams): CompletableFuture<StatementListPageAsync> =
    ...
    fun list(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<StatementListPageAsync>
    ...
    interface WithRawResponse {
        ...
        fun list(
            params: StatementListParams
        ): CompletableFuture<HttpResponseFor<StatementListPageAsync>> =
            list(params, RequestOptions.none())
