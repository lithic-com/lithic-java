...
class CardServiceAsyncImpl constructor(private val clientOptions: ClientOptions,) : CardServiceAsync {
     ...
     */
    override fun embed(params: CardEmbedParams, requestOptions: RequestOptions): CompletableFuture<String> {
      val request = HttpRequest.builder()
        .method(HttpMethod.GET)
     ...
     */
    override fun provision(params: CardProvisionParams, requestOptions: RequestOptions): CompletableFuture<CardProvisionResponse> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
     ...
     */
    override fun reissue(params: CardReissueParams, requestOptions: RequestOptions): CompletableFuture<Card> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
