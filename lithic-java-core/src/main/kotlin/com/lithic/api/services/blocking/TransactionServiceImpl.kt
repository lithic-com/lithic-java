...
class TransactionServiceImpl constructor(private val clientOptions: ClientOptions,) : TransactionService {
     ...
     * endpoint.
     */
    override fun simulateAuthorization(params: TransactionSimulateAuthorizationParams, requestOptions: RequestOptions): TransactionSimulateAuthorizationResponse {
      val request = HttpRequest.builder()
     ...
     */
    override fun simulateClearing(params: TransactionSimulateClearingParams, requestOptions: RequestOptions): TransactionSimulateClearingResponse {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
     ...
     * network.
     */
    override fun simulateCreditAuthorization(params: TransactionSimulateCreditAuthorizationParams, requestOptions: RequestOptions): TransactionSimulateCreditAuthorizationResponse {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
     ...
     */
    override fun simulateReturn(params: TransactionSimulateReturnParams, requestOptions: RequestOptions): TransactionSimulateReturnResponse {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
     ...
     */
    override fun simulateReturnReversal(params: TransactionSimulateReturnReversalParams, requestOptions: RequestOptions): TransactionSimulateReturnReversalResponse {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
     ...
     */
    override fun simulateVoid(params: TransactionSimulateVoidParams, requestOptions: RequestOptions): TransactionSimulateVoidResponse {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
