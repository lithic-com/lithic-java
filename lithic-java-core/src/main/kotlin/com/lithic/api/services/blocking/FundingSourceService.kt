...
interface FundingSourceService {
     ...
     */
    @JvmOverloads
    fun create(params: FundingSourceCreateParams, requestOptions: RequestOptions = RequestOptions.none()): FundingSource

    /** Update a funding source. */
    @JvmOverloads
    fun update(params: FundingSourceUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): FundingSource

    /** List all the funding sources associated with the Lithic account. */
    @JvmOverloads
    fun list(params: FundingSourceListParams, requestOptions: RequestOptions = RequestOptions.none()): FundingSourceListPage
     ...
     */
    @JvmOverloads
    fun verify(params: FundingSourceVerifyParams, requestOptions: RequestOptions = RequestOptions.none()): FundingSource
}
