...
interface V2ServiceAsync {
    ...
    fun create(params: V2CreateParams): CompletableFuture<V2CreateResponse> =
    ...
    fun retrieve(params: V2RetrieveParams): CompletableFuture<V2RetrieveResponse> =
     ...
     */
    fun update(params: V2UpdateParams): CompletableFuture<V2UpdateResponse> =
    ...
    fun list(): CompletableFuture<V2ListPageAsync> = list(V2ListParams.none())
    ...
    /** @see [list] */
    fun list(params: V2ListParams = V2ListParams.none()): CompletableFuture<V2ListPageAsync> =
        list(params, RequestOptions.none())

    /** @see [list] */
    fun list(requestOptions: RequestOptions): CompletableFuture<V2ListPageAsync> =
     ...
     */
    fun apply(params: V2ApplyParams): CompletableFuture<V2ApplyResponse> =
     ...
     */
    fun draft(params: V2DraftParams): CompletableFuture<V2DraftResponse> =
     ...
     */
    fun promote(params: V2PromoteParams): CompletableFuture<V2PromoteResponse> =
     ...
     * the report.
     */
    fun report(params: V2ReportParams): CompletableFuture<V2ReportResponse> =
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun create(params: V2CreateParams): CompletableFuture<HttpResponseFor<V2CreateResponse>> =
            create(params, RequestOptions.none())
         ...
         */
        @MustBeClosed
        fun update(params: V2UpdateParams): CompletableFuture<HttpResponseFor<V2UpdateResponse>> =
            update(params, RequestOptions.none())
         ...
         */
        @MustBeClosed
        fun list(): CompletableFuture<HttpResponseFor<V2ListPageAsync>> = list(V2ListParams.none())
        ...
        fun list(
            params: V2ListParams = V2ListParams.none()
        ): CompletableFuture<HttpResponseFor<V2ListPageAsync>> = list(params, RequestOptions.none())
         ...
         */
        @MustBeClosed
        fun apply(params: V2ApplyParams): CompletableFuture<HttpResponseFor<V2ApplyResponse>> =
            apply(params, RequestOptions.none())
         ...
         */
        @MustBeClosed
        fun draft(params: V2DraftParams): CompletableFuture<HttpResponseFor<V2DraftResponse>> =
            draft(params, RequestOptions.none())
         ...
         */
        @MustBeClosed
        fun report(params: V2ReportParams): CompletableFuture<HttpResponseFor<V2ReportResponse>> =
            report(params, RequestOptions.none())
