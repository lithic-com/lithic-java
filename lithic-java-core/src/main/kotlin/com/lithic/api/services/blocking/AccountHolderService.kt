...
interface AccountHolderService {
     ...
     */
    @JvmOverloads
    fun create(params: AccountHolderCreateParams, requestOptions: RequestOptions = RequestOptions.none()): AccountHolder
     ...
     */
    @JvmOverloads
    fun retrieve(params: AccountHolderRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): AccountHolder

    /** Update the information associated with a particular account holder. */
    @JvmOverloads
    fun update(params: AccountHolderUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): AccountHolderUpdateResponse
     ...
     */
    @JvmOverloads
    fun createWebhook(params: AccountHolderCreateWebhookParams, requestOptions: RequestOptions = RequestOptions.none()): AccountHolderCreateWebhookResponse
     ...
     */
    @JvmOverloads
    fun listDocuments(params: AccountHolderListDocumentsParams, requestOptions: RequestOptions = RequestOptions.none()): AccountHolderListDocumentsResponse
     ...
     */
    @JvmOverloads
    fun resubmit(params: AccountHolderResubmitParams, requestOptions: RequestOptions = RequestOptions.none()): AccountHolder
     ...
     */
    @JvmOverloads
    fun retrieveDocument(params: AccountHolderRetrieveDocumentParams, requestOptions: RequestOptions = RequestOptions.none()): AccountHolderDocument
     ...
     */
    @JvmOverloads
    fun uploadDocument(params: AccountHolderUploadDocumentParams, requestOptions: RequestOptions = RequestOptions.none()): AccountHolderDocument
}
