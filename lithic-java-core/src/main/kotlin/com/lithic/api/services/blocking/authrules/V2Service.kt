...
interface V2Service {
    ...
    fun create(params: V2CreateParams): V2CreateResponse = create(params, RequestOptions.none())
    ...
    fun retrieve(params: V2RetrieveParams): V2RetrieveResponse =
     ...
     */
    fun update(params: V2UpdateParams): V2UpdateResponse = update(params, RequestOptions.none())
    ...
    fun list(): V2ListPage = list(V2ListParams.none())
    ...
    /** @see [list] */
    fun list(params: V2ListParams = V2ListParams.none()): V2ListPage =
     ...
     */
    fun apply(params: V2ApplyParams): V2ApplyResponse = apply(params, RequestOptions.none())
     ...
     */
    fun draft(params: V2DraftParams): V2DraftResponse = draft(params, RequestOptions.none())
     ...
     */
    fun promote(params: V2PromoteParams): V2PromoteResponse = promote(params, RequestOptions.none())
     ...
     * the report.
     */
    fun report(params: V2ReportParams): V2ReportResponse = report(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun create(params: V2CreateParams): HttpResponseFor<V2CreateResponse> =
         ...
         */
        @MustBeClosed
        fun retrieve(params: V2RetrieveParams): HttpResponseFor<V2RetrieveResponse> =
            retrieve(params, RequestOptions.none())
         ...
         */
        @MustBeClosed
        fun update(params: V2UpdateParams): HttpResponseFor<V2UpdateResponse> =
         ...
         * [V2Service.list].
         */
        @MustBeClosed fun list(): HttpResponseFor<V2ListPage> = list(V2ListParams.none())
        ...
        /** @see [list] */
        @MustBeClosed
        fun list(params: V2ListParams = V2ListParams.none()): HttpResponseFor<V2ListPage> =
            list(params, RequestOptions.none())
         ...
         */
        @MustBeClosed
        fun apply(params: V2ApplyParams): HttpResponseFor<V2ApplyResponse> =
         ...
         */
        @MustBeClosed
        fun draft(params: V2DraftParams): HttpResponseFor<V2DraftResponse> =
         ...
         */
        @MustBeClosed
        fun promote(params: V2PromoteParams): HttpResponseFor<V2PromoteResponse> =
         ...
         */
        @MustBeClosed
        fun report(params: V2ReportParams): HttpResponseFor<V2ReportResponse> =
