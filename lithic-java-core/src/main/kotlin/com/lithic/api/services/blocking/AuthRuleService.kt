...
interface AuthRuleService {
     ...
     */
    fun withOptions(modifier: Consumer<ClientOptions.Builder>): AuthRuleService
    ...
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: Consumer<ClientOptions.Builder>): AuthRuleService.WithRawResponse
