...
interface AuthStreamEnrollmentService {
     ...
     */
    @JvmOverloads
    fun retrieveSecret(params: AuthStreamEnrollmentRetrieveSecretParams, requestOptions: RequestOptions = RequestOptions.none()): AuthStreamSecret
     ...
     */
    @JvmOverloads
    fun rotateSecret(params: AuthStreamEnrollmentRotateSecretParams, requestOptions: RequestOptions = RequestOptions.none())
}
