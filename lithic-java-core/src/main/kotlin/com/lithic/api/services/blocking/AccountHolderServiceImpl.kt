...
class AccountHolderServiceImpl constructor(private val clientOptions: ClientOptions,) : AccountHolderService {
     ...
     */
    override fun create(params: AccountHolderCreateParams, requestOptions: RequestOptions): AccountHolder {
    ...
    override fun retrieve(params: AccountHolderRetrieveParams, requestOptions: RequestOptions): AccountHolder {
      val request = HttpRequest.builder()
    ...
    override fun update(params: AccountHolderUpdateParams, requestOptions: RequestOptions): AccountHolderUpdateResponse {
      val request = HttpRequest.builder()
     ...
     */
    override fun createWebhook(params: AccountHolderCreateWebhookParams, requestOptions: RequestOptions): AccountHolderCreateWebhookResponse {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
     ...
     */
    override fun listDocuments(params: AccountHolderListDocumentsParams, requestOptions: RequestOptions): AccountHolderListDocumentsResponse {
      val request = HttpRequest.builder()
        .method(HttpMethod.GET)
     ...
     */
    override fun resubmit(params: AccountHolderResubmitParams, requestOptions: RequestOptions): AccountHolder {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
     ...
     */
    override fun retrieveDocument(params: AccountHolderRetrieveDocumentParams, requestOptions: RequestOptions): AccountHolderDocument {
      val request = HttpRequest.builder()
        .method(HttpMethod.GET)
     ...
     * verification.
     */
    override fun uploadDocument(params: AccountHolderUploadDocumentParams, requestOptions: RequestOptions): AccountHolderDocument {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
        .addPathSegments("account_holders", params.getPathParam(0), "documents")
        .putAllQueryParams(params.toQueryParams())
