...
interface TokenizationDecisioningService {
     ...
     */
    @JvmOverloads
    fun retrieveSecret(params: TokenizationDecisioningRetrieveSecretParams, requestOptions: RequestOptions = RequestOptions.none()): TokenizationSecret
     ...
     */
    @JvmOverloads
    fun rotateSecret(params: TokenizationDecisioningRotateSecretParams, requestOptions: RequestOptions = RequestOptions.none()): TokenizationDecisioningRotateSecretResponse
}
