...
class AccountHolderServiceTest {
    ...
    fun callCreate() {
      ...
      val accountHolder = accountHolderService.create(AccountHolderCreateParams.builder()
    ...
    fun callRetrieve() {
      val client = LithicOkHttpClient.builder()
          ...
          .build()
      val accountHolderService = client.accountHolders()
      val accountHolder = accountHolderService.retrieve(AccountHolderRetrieveParams.builder()
    ...
    fun callUpdate() {
      val client = LithicOkHttpClient.builder()
          ...
          .build()
      val accountHolderService = client.accountHolders()
      val accountHolderUpdateResponse = accountHolderService.update(AccountHolderUpdateParams.builder()
          .accountHolderToken("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .email("string")
          .phoneNumber("string")
          .build())
    ...
    fun callCreateWebhook() {
      val client = LithicOkHttpClient.builder()
          ...
          .build()
      val accountHolderService = client.accountHolders()
      val accountHolderCreateWebhookResponse = accountHolderService.createWebhook(AccountHolderCreateWebhookParams.builder()
          .url("string")
          .build())
    ...
    fun callListDocuments() {
      val client = LithicOkHttpClient.builder()
          ...
          .build()
      val accountHolderService = client.accountHolders()
      val accountHolderListDocumentsResponse = accountHolderService.listDocuments(AccountHolderListDocumentsParams.builder()
          .accountHolderToken("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .build())
    ...
    fun callResubmit() {
      val client = LithicOkHttpClient.builder()
          ...
          .build()
      val accountHolderService = client.accountHolders()
      val accountHolder = accountHolderService.resubmit(AccountHolderResubmitParams.builder()
          .accountHolderToken("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .workflow(AccountHolderResubmitParams.Workflow.KYC_ADVANCED)
          .tosTimestamp("2022-03-08 08:00:00")
          .individual(AccountHolderResubmitParams.Individual.builder()
              .address(Address.builder()
                  .address1("123 Old Forest Way")
                  .address2("string")
                  .city("Omaha")
    ...
    fun callRetrieveDocument() {
      val client = LithicOkHttpClient.builder()
          ...
          .build()
      val accountHolderService = client.accountHolders()
      val accountHolderDocument = accountHolderService.retrieveDocument(AccountHolderRetrieveDocumentParams.builder()
          .accountHolderToken("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
    ...
    fun callUploadDocument() {
      val client = LithicOkHttpClient.builder()
          ...
          .build()
      val accountHolderService = client.accountHolders()
      val accountHolderDocument = accountHolderService.uploadDocument(AccountHolderUploadDocumentParams.builder()
          .accountHolderToken("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
