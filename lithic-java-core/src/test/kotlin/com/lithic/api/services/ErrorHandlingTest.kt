...
import com.lithic.api.errors.LithicServiceException
...
class ErrorHandlingTest {
    ...
    private val LITHIC_ERROR: LithicError = LithicError.builder().putAdditionalProperty("key", JsonString.of("value")).build()

    private lateinit var client: LithicClient

    @BeforeEach
    fun beforeEach(wmRuntimeInfo: WireMockRuntimeInfo) {
      client = LithicOkHttpClient.builder()
          .apiKey(API_KEY)
    ...
    fun cardsCreate_200() {
      ...
      val expected = Card.builder()
          .created(OffsetDateTime.parse("2021-06-28T22:53:15Z"))
          .cvv("776")
          .funding(Card.FundingAccount.builder()
              .accountName("string")
    ...
    fun cardsCreate_400() {
      ...
      assertThatThrownBy({ client.cards().create(params) })
          .satisfies({ e -> assertBadRequest(e, ImmutableListMultimap.of("Foo", "Bar"), LITHIC_ERROR) })
    }
    ...
    fun cardsCreate_401() {
      ...
      assertThatThrownBy({ client.cards().create(params) })
          .satisfies({ e -> assertUnauthorized(e, ImmutableListMultimap.of("Foo", "Bar"), LITHIC_ERROR) })
    }
    ...
    fun cardsCreate_403() {
      ...
      assertThatThrownBy({ client.cards().create(params) })
          .satisfies({ e -> assertPermissionDenied(e, ImmutableListMultimap.of("Foo", "Bar"), LITHIC_ERROR) })
    }
    ...
    fun cardsCreate_404() {
      ...
      assertThatThrownBy({ client.cards().create(params) })
          .satisfies({ e -> assertNotFound(e, ImmutableListMultimap.of("Foo", "Bar"), LITHIC_ERROR) })
    }
    ...
    fun cardsCreate_422() {
      ...
      assertThatThrownBy({ client.cards().create(params) })
          .satisfies({ e -> assertUnprocessableEntity(e, ImmutableListMultimap.of("Foo", "Bar"), LITHIC_ERROR) })
    }
    ...
    fun cardsCreate_429() {
      ...
      assertThatThrownBy({ client.cards().create(params) })
          .satisfies({ e -> assertRateLimit(e, ImmutableListMultimap.of("Foo", "Bar"), LITHIC_ERROR) })
    }
    ...
    fun cardsCreate_500() {
      ...
      assertThatThrownBy({ client.cards().create(params) })
          .satisfies({ e -> assertInternalServer(e, ImmutableListMultimap.of("Foo", "Bar"), LITHIC_ERROR) })
    }
    ...
    fun unexpectedStatusCode() {
      ...
      assertThatThrownBy({ client.cards().create(params) }).satisfies({ e -> assertUnexpectedStatusCodeException(e, 999, ImmutableListMultimap.of("Foo", "Bar"), toJson(LITHIC_ERROR)) })
    }
    ...
    fun invalidBody() {
      ...
      assertThatThrownBy({ client.cards().create(params) }).satisfies({ e -> assertThat(e)
    ...
    fun invalidErrorBody() {
      ...
      assertThatThrownBy({ client.cards().create(params) }).satisfies({ e -> assertBadRequest(e, ImmutableListMultimap.of(), LithicError.builder().build()) })
    }
    ...
    private fun assertBadRequest(throwable: Throwable, headers: ListMultimap<String, String>, error: LithicError) {
      assertThat(throwable)
    ...
    private fun assertUnauthorized(throwable: Throwable, headers: ListMultimap<String, String>, error: LithicError) {
      assertThat(throwable)
    ...
    private fun assertPermissionDenied(throwable: Throwable, headers: ListMultimap<String, String>, error: LithicError) {
      assertThat(throwable)
    ...
    private fun assertNotFound(throwable: Throwable, headers: ListMultimap<String, String>, error: LithicError) {
      assertThat(throwable)
    ...
    private fun assertUnprocessableEntity(throwable: Throwable, headers: ListMultimap<String, String>, error: LithicError) {
      assertThat(throwable)
    ...
    private fun assertRateLimit(throwable: Throwable, headers: ListMultimap<String, String>, error: LithicError) {
      assertThat(throwable)
    ...
    private fun assertInternalServer(throwable: Throwable, headers: ListMultimap<String, String>, error: LithicError) {
      assertThat(throwable)
