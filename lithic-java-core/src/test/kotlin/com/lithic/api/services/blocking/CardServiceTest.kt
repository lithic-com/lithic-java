...
class CardServiceTest {
    ...
    fun callEmbed() {
      val client = LithicOkHttpClient.builder()
          ...
          .build()
      val cardService = client.cards()
      val cardEmbedResponse = cardService.embed(CardEmbedParams.builder()
          .embedRequest("string")
          .hmac("string")
          .build())
    ...
    fun callProvision() {
      val client = LithicOkHttpClient.builder()
          ...
          .build()
      val cardService = client.cards()
      val cardProvisionResponse = cardService.provision(CardProvisionParams.builder()
          .cardToken("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
    ...
    fun callReissue() {
      val client = LithicOkHttpClient.builder()
          ...
          .build()
      val cardService = client.cards()
      val card = cardService.reissue(CardReissueParams.builder()
          .cardToken("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .shippingAddress(ShippingAddress.builder()
              .firstName("Michael")
              .lastName("Bluth")
    ...
    fun callGetEmbedHtml() {
        ...
        val cardEmbedResponse =
            cardService.getEmbedHtml(
                CardGetEmbedHtmlParams.builder().token("foo").build()
            )
        println(cardEmbedResponse)
