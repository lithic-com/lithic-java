...
internal class CardProvisionParamsTest {
    ...
    fun body() {
        ...
        assertThat(body.clientDeviceId()).contains("d3538acf-e5df-4446-8ce6-588fa4472ac1")
        assertThat(body.clientWalletAccountId()).contains("d3538acf-e5df-4446-8ce6-588fa4472ac1")
