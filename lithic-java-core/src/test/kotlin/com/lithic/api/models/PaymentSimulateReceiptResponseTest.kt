...
internal class PaymentSimulateReceiptResponseTest {
    ...
    fun roundtrip() {
        ...
        val roundtrippedPaymentSimulateReceiptResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(paymentSimulateReceiptResponse),
                jacksonTypeRef<PaymentSimulateReceiptResponse>(),
            )

        assertThat(roundtrippedPaymentSimulateReceiptResponse)
            .isEqualTo(paymentSimulateReceiptResponse)
    }
}
