...
import com.lithic.api.models.AccountHolderResubmitParams.AccountHolderResubmitBody
...
class AccountHolderResubmitParamsTest {
    ...
    @Test
    fun toBody() {
      val params = AccountHolderResubmitParams.builder()
          .accountHolderToken("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .workflow(AccountHolderResubmitParams.Workflow.KYC_ADVANCED)
          .tosTimestamp("2022-03-08 08:00:00")
          .individual(AccountHolderResubmitParams.Individual.builder()
      ...
      assertThat(body.individual()).isEqualTo(AccountHolderResubmitParams.Individual.builder()
          .address(Address.builder()
              .address1("123 Old Forest Way")
              .address2("string")
              .city("Omaha")
