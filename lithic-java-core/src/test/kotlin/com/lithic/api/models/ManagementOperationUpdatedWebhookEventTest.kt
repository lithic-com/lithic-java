...
internal class ManagementOperationUpdatedWebhookEventTest {
    ...
    fun create() {
        ...
        assertThat(managementOperationUpdatedWebhookEvent.currency()).contains("currency")
        ...
        assertThat(managementOperationUpdatedWebhookEvent.events().getOrNull())
            .containsExactly(
                ManagementOperationTransaction.ManagementOperationEvent.builder()
                    .token("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .amount(0L)
        ...
        assertThat(managementOperationUpdatedWebhookEvent.pendingAmount()).contains(0L)
        ...
        assertThat(managementOperationUpdatedWebhookEvent.settledAmount()).contains(0L)
