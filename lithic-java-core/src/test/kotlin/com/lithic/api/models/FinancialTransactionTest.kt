...
internal class FinancialTransactionTest {
    ...
    fun roundtrip() {
        ...
        val roundtrippedFinancialTransaction =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(financialTransaction),
                jacksonTypeRef<FinancialTransaction>(),
            )

        assertThat(roundtrippedFinancialTransaction).isEqualTo(financialTransaction)
    }
}
