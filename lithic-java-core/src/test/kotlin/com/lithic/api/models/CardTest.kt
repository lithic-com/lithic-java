...
internal class CardTest {
    ...
    fun create() {
        ...
        assertThat(card.bulkOrderToken()).contains("5e9483eb-8103-4e16-9794-2106111b2eca")
        assertThat(card.cardholderCurrency()).contains("USD")
        assertThat(card.comment()).contains("comment")
        assertThat(card.digitalCardArtToken()).contains("5e9483eb-8103-4e16-9794-2106111b2eca")
        ...
        assertThat(card.networkProgramToken()).contains("5e9483eb-8103-4e16-9794-2106111b2eca")
        ...
        assertThat(card.substatus()).contains(NonPciCard.Substatus.LOST)
