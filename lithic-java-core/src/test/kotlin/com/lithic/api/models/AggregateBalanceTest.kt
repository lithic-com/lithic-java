...
internal class AggregateBalanceTest {
    ...
    fun roundtrip() {
        ...
        val roundtrippedAggregateBalance =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(aggregateBalance),
                jacksonTypeRef<AggregateBalance>(),
            )

        assertThat(roundtrippedAggregateBalance).isEqualTo(aggregateBalance)
    }
}
