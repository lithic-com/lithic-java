...
internal class NonPciCardTest {
    ...
    fun create() {
        ...
        assertThat(nonPciCard.cardholderCurrency()).contains("USD")
        assertThat(nonPciCard.comment()).contains("comment")
        assertThat(nonPciCard.digitalCardArtToken())
            .contains("5e9483eb-8103-4e16-9794-2106111b2eca")
        assertThat(nonPciCard.expMonth()).contains("06")
        assertThat(nonPciCard.expYear()).contains("2027")
        assertThat(nonPciCard.hostname()).contains("hostname")
        assertThat(nonPciCard.memo()).contains("New Card")
        assertThat(nonPciCard.networkProgramToken())
            .contains("5e9483eb-8103-4e16-9794-2106111b2eca")
        assertThat(nonPciCard.pendingCommands().getOrNull()).containsExactly("string")
        assertThat(nonPciCard.productId()).contains("1")
        assertThat(nonPciCard.replacementFor()).contains("5e9483eb-8103-4e16-9794-2106111b2eca")
        assertThat(nonPciCard.substatus()).contains(NonPciCard.Substatus.LOST)
    }
