...
internal class SettlementDetailTest {
    ...
    fun create() {
        ...
        assertThat(settlementDetail.accountToken()).contains("e34a817f-119d-4976-9fb3-8b020b8bbec3")
        assertThat(settlementDetail.cardProgramToken())
            .contains("e34a817f-119d-4976-9fb3-8b020b8bbec3")
        assertThat(settlementDetail.cardToken()).contains("e34a817f-119d-4976-9fb3-8b020b8bbec3")
