...
import com.lithic.api.models.CardReissueParams.CardReissueBody
...
class CardReissueParamsTest {
    ...
    @Test
    fun toBody() {
      val params = CardReissueParams.builder()
          .cardToken("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .shippingAddress(ShippingAddress.builder()
              .firstName("Michael")
              .lastName("Bluth")
      ...
      assertThat(body.shippingAddress()).isEqualTo(ShippingAddress.builder()
          .firstName("Michael")
          .lastName("Bluth")
          .line2Text("The Bluth Company")
          .address1("5 Broad Street")
