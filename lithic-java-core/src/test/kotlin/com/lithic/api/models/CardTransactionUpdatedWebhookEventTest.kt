...
internal class CardTransactionUpdatedWebhookEventTest {
    ...
    fun create() {
        ...
        assertThat(cardTransactionUpdatedWebhookEvent.acquirerFee()).contains(0L)
        assertThat(cardTransactionUpdatedWebhookEvent.acquirerReferenceNumber()).isEmpty
        ...
        assertThat(cardTransactionUpdatedWebhookEvent.authorizationAmount()).contains(1800L)
        assertThat(cardTransactionUpdatedWebhookEvent.authorizationCode()).contains("071471")
        ...
        assertThat(cardTransactionUpdatedWebhookEvent.merchantAmount()).contains(1800L)
        assertThat(cardTransactionUpdatedWebhookEvent.merchantAuthorizationAmount()).contains(1800L)
        ...
        assertThat(cardTransactionUpdatedWebhookEvent.network())
            .contains(Transaction.Network.MASTERCARD)
        assertThat(cardTransactionUpdatedWebhookEvent.networkRiskScore()).contains(5L)
        ...
        assertThat(cardTransactionUpdatedWebhookEvent.updated())
            .isEqualTo(OffsetDateTime.parse("2023-08-03T18:42:30Z"))
        assertThat(cardTransactionUpdatedWebhookEvent.events().getOrNull())
            .containsExactly(
                Transaction.TransactionEvent.builder()
                    .token("bbbf1e86-322d-11ee-9779-00505685a123")
                    .amount(1800L)
