...
import com.lithic.api.models.EventsSubscriptionUpdateParams.EventsSubscriptionUpdateBody
...
class EventsSubscriptionUpdateParamsTest {
    ...
    @Test
    fun getBody() {
      val params = EventsSubscriptionUpdateParams.builder()
          .eventSubscriptionToken("string")
          .description("string")
          .disabled(true)
          .eventTypes(listOf(EventsSubscriptionUpdateParams.EventType.DISPUTE_UPDATED))
      ...
      assertThat(body.eventTypes()).isEqualTo(listOf(EventsSubscriptionUpdateParams.EventType.DISPUTE_UPDATED))
